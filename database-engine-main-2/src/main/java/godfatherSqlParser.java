...
public class godfatherSqlParser extends Parser {
	...
	public static final int
		...
		LT=39, LE=40, NE=41, AND=42, OR=43, QUOTED_STRING=44, INTEGER_VALUE=45, 
		DECIMAL_VALUE=46, DATE=47, IDENTIFIER=48, WS=49, XOR=50;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OR", "QUOTED_STRING", "INTEGER_VALUE", "DECIMAL_VALUE", "DATE", "IDENTIFIER", 
			"WS", "XOR"
		};
	}
	...
	public final OperatorContext operator() throws RecognitionException {
		...
		try {
			...
			setState(194);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1139094046375936L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
